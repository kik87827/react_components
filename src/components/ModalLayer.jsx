          ...
          <div className={styles.modalTd}>
            <div className={styles.modalBox}>
              ...
              <div className={styles.modalControlWrap}>
                <a href="#" className={`${styles.btnModalControl} ${styles.theme_2}`} onClick={(e)=>{
                  e.preventDefault();
                  if(onClose) onClose();
                ...
                {
                  roleType === "confirm" && <a href="#" className={styles.btnModalControl} onClick={(e)=>{
                    e.preventDefault();
                    if(onClose) onClose();
                  }}>
                    <span>취소</span>
              ...
              <a href="#" className={styles.btnModalClose} onClick={(e)=>{
                e.preventDefault();
                if(onClose) onClose();
              }}></a>
            </div>
